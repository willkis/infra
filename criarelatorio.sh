...
ldapsearch -h 10.170.52.21 -w '!t!mb!ru3s3' -D uid="itim, ou=Special Users,dc=tim,dc=com,dc=br" -b "ou=people,dc=tim,dc=com,dc=br" '(&(statusflag=active)(certificateserialnumber=*))' uid scSerialNumber dateExpiration > /tmp/gcsm.txt
